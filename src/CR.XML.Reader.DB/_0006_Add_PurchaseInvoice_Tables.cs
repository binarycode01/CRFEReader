...
{
    [Migration(6, "Add the main tables for Export Invoice")]
    public class _0006_Add_PurchaseInvoice_Tables : Migration
    {
        public override void Down()
        {
            Delete.Table("FacturaCompra");
            Delete.Table("FacturaCompraMedioPago");
            Delete.Table("FacturaCompraDetalle");
            Delete.Table("FacturaCompraDetalleCodigoComercial");
            Delete.Table("FacturaCompraImpuesto");
            Delete.Table("FacturaCompraDescuento");
            Delete.Table("FacturaCompraOtrosCargos");
            Delete.Table("FacturaCompraResumen");
            Delete.Table("FacturaCompraInformacionReferencia");
            Delete.Table("FacturaCompraOtrosTexto");
            Delete.Table("FacturaCompraOtroContenido");
        }
        ...
        public override void Up()
        {
            ...
            // FacturaCompraMedioPago
            Create.Table("FacturaCompraMedioPago")
                .WithColumn("Clave").AsString().NotNullable().ForeignKey("FacturaCompra", "Clave").PrimaryKey()
            ...
            Create.Table("FacturaCompraDetalleCodigoComercial")
                .WithColumn("Clave").AsString().NotNullable().ForeignKey("FacturaCompra", "Clave")
                .WithColumn("NumeroLinea").AsString().NotNullable()
                .WithColumn("Tipo").AsString().Nullable()
                .WithColumn("Codigo").AsString().Nullable();

            // Impuestos tabla
            Create.Table("FacturaCompraImpuesto")
                .WithColumn("Clave").AsString().NotNullable().ForeignKey("FacturaCompra", "Clave")
                .WithColumn("NumeroLinea").AsString().NotNullable()
            ...
            Create.Table("FacturaCompraResumen")
                .WithColumn("Clave").AsString().NotNullable().ForeignKey("FacturaCompra", "Clave").PrimaryKey()
            ...
            Create.Table("FacturaCompraInformacionReferencia")
                .WithColumn("Clave").AsString().NotNullable().ForeignKey("FacturaCompra", "Clave")
            ...
            Create.Table("FacturaCompraOtrosTexto")
                .WithColumn("Clave").AsString().NotNullable().ForeignKey("FacturaCompra", "Clave")
                .WithColumn("Codigo").AsString().NotNullable()
                .WithColumn("Value").AsString().NotNullable();

            Create.Table("FacturaCompraOtroContenido")
                .WithColumn("Clave").AsString().NotNullable().ForeignKey("FacturaCompra", "Clave")
